        ...
        <CardBody className="p-0 bg-black auth-header-box rounded-top">
          <div className="text-center p-3">
            <Link href="/" className="logo logo-admin">
              <BrandImage target="authReset" width={640} height={360} alt="Florida Mobility Group reset logo" className="auth-logo" style={{ width: '100%', maxWidth: 320, height: 'auto', objectFit: 'contain' }} />
            </Link>
