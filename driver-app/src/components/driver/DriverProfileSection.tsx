...
export const DriverProfileSection = ({ runtime }: Props) => {
  ...
  return <View style={driverSharedStyles.card}>
      ...
      <View style={styles.formCard}>
        ...
        <Pressable style={styles.primaryButton} onPress={() => void runtime.updateDriverProfile({ name: draftName, email: draftEmail, phone: draftPhone, address: draftAddress })} disabled={runtime.isSavingProfile}>
