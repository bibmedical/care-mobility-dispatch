...
const LogoBox = () => {
  return <div className="d-flex align-items-center h-100 px-3 py-2" style={{ position: 'relative' }}>
      ...
      boxShadow: '0 0 0 3px rgba(7, 18, 38, 0.9), 0 8px 20px rgba(0, 0, 0, 0.35)'
        ...
        <BrandImage target="portalSidebar" alt="Florida Mobility Group portal logo" width={48} height={28} style={{ width: '100%', height: '100%', objectFit: 'contain', padding: '6px 5px' }} />
      </Link>
