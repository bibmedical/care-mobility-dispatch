...
const TRIP_DASHBOARD_MAP_LAYER_OPTIONS = [{
  ...
  value: 'driver-route',
  label: 'Layers: Driver + Route'
}, {
  value: 'driver-selected',
  label: 'Layers: Driver + Trip'
}, {
  value: 'route-selected',
  label: 'Layers: Route + Trip'
}, {
  value: 'route-only',
  label: 'Layers: Route Only'
}, {
  value: 'selected-only',
  label: 'Layers: Trip Only'
}, {
  value: 'driver-only',
  label: 'Layers: Driver Only'
}];

const getTripDashboardMapLayerVisibility = preset => {
  switch (String(preset || '').trim()) {
    case 'driver-route':
      return { drivers: true, route: true, selectedTrips: false };
    case 'driver-selected':
      return { drivers: true, route: false, selectedTrips: true };
    case 'route-selected':
      return { drivers: false, route: true, selectedTrips: true };
    case 'route-only':
      return { drivers: false, route: true, selectedTrips: false };
    case 'selected-only':
      return { drivers: false, route: false, selectedTrips: true };
    case 'driver-only':
      return { drivers: true, route: false, selectedTrips: false };
    case 'all':
    default:
      return { drivers: true, route: true, selectedTrips: true };
  }
};
...
const TripDashboardWorkspace = () => {
  ...
  const liveScanAnalysisTrips = useMemo(() => scanAnnotatedTrips.filter(matchesTripDateFilter).filter(matchesTripTypeFilter).filter(matchesTripServiceAnimalFilter).filter(matchesTripSearchFilter).filter(matchesPickupZipFilter).filter(matchesDropoffZipFilter).filter(matchesAnyZipFilter).filter(trip => {
    ...
    const dropoffCityValue = doCityFilter.trim().toLowerCase();
    return tripMatchesCity(trip, dropoffCityValue);
  }), [doCityFilter, matchesAnyZipFilter, matchesPickupZipFilter, matchesDropoffZipFilter, matchesTripDateFilter, matchesTripSearchFilter, matchesTripServiceAnimalFilter, matchesTripTypeFilter, puCityFilter, scanAnnotatedTrips]);
  ...
  }, [liveScanAnalysisTrips, visibleFilteredTripIdSet]);
  ...
  const mapQuickTripPoints = useMemo(() => {
    if (!showSelectedTripMapLayer || selectedTrips.length > 0) return [];

    return mapQuickTrips.flatMap(trip => {
  ...
  }, [activeDateTripIdSet, selectedTrips, showSelectedTripMapLayer, timeDisplayMode]);
        ...
        {showInlineMap ? <div className="position-relative h-100">
          ...
          color: '#f8fafc'
            ...
            vehicleIconScalePercent: driver?.gpsSettings?.vehicleIconScalePercent
              ...
              {mapQuickTripPoints.map(point => <CircleMarker key={point.key} center={point.position} radius={6} pathOptions={{ color: point.color, fillColor: point.color, fillOpacity: 0.85 }} eventHandlers={{
            click: () => {
  ...
  return <>
      ...
      <div ref={workspaceRef} style={workspaceGridStyle}>
          ...
          {isPeekPanelMode ? <Card className="h-100 overflow-hidden">
            ...
            <CardBody className="p-0 d-flex flex-column h-100">
              ...
              backgroundColor: isDarkTheme ? '#101827' : '#ffffff'
                  ...
                  paddingBottom: '1rem'
                    ...
                    <div className="d-flex align-items-center gap-2 flex-wrap justify-content-end">
                      ...
                      <div className="d-inline-flex align-items-center gap-2 px-2 py-1 rounded-3" style={{ backgroundColor: 'rgba(255, 255, 255, 0.16)', border: '1px solid rgba(255, 255, 255, 0.24)' }}>
                        <span className="small fw-semibold" style={{ color: '#ffffff', letterSpacing: '0.03em', fontSize: 11 }}>Colors</span>
                        <PowerToggleButton
              ...
              <div ref={tripTableBottomScrollerRef} className="table-responsive flex-grow-1 trip-dashboard-sheet-wrap" onScroll={() => syncTripTableScroll('bottom')} style={{ minHeight: 0, height: '100%', maxHeight: '100%', overflowX: 'auto', overflowY: 'auto', scrollbarGutter: 'auto', scrollbarWidth: 'thin', msOverflowStyle: 'auto', paddingBottom: 0 }}>
                <Table ref={tripTableElementRef} hover className={`align-middle mb-0 trip-dashboard-sheet-table ${showScannerRowColors ? 'trip-dashboard-sheet-table--scanner-colors' : 'trip-dashboard-sheet-table--scanner-neutral'}`} data-bs-theme={themeMode} style={{ whiteSpace: 'nowrap', minWidth: 'max-content', width: 'max-content', borderCollapse: 'separate', borderSpacing: 0 }}>
                  ...
                  <tbody>
                    ...
                    const isAlTripRow = tripLegKey === 'AL';
                    return <tr key={row.trip.id} className={isSelectedTripRow ? 'table-primary' : isAssignedTripRow ? 'table-success' : ''} data-trip-row={isAlTripRow ? 'al' : undefined}>
                        <td>
                          <input
                            type="checkbox"
        ...
        <style jsx global>{`
          ...
          .trip-dashboard-sheet-table tbody tr[data-trip-row='al'] td {
            background: #9ca3af !important;
            color: #f8fafc !important;
          }

          .trip-dashboard-sheet-table tbody tr[data-trip-row='al'] .text-muted,
          .trip-dashboard-sheet-table tbody tr[data-trip-row='al'] .small.text-muted {
            color: rgba(248, 250, 252, 0.9) !important;
            opacity: 1 !important;
          }

          .trip-dashboard-sheet-table tbody tr[data-trip-row='al'] .btn-outline-secondary,
          .trip-dashboard-sheet-table tbody tr[data-trip-row='al'] .btn-outline-success,
          .trip-dashboard-sheet-table tbody tr[data-trip-row='al'] .btn-outline-primary,
          .trip-dashboard-sheet-table tbody tr[data-trip-row='al'] .btn-outline-info,
          .trip-dashboard-sheet-table tbody tr[data-trip-row='al'] .btn-outline-danger {
            --bs-btn-color: #f8fafc;
          ...
          .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody tr td {
            background: #f4f5f7 !important;
            color: #18212a !important;
          }

          .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody tr:nth-child(even) td {
            background: #eceff3 !important;
          }

          .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody tr.table-primary td {
            background: #dfe5ec !important;
            color: #18212a !important;
            box-shadow: inset 3px 0 0 #7c8b9c;
          }

          .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody tr.table-success td {
            background: #e7eaee !important;
            color: #18212a !important;
            box-shadow: inset 3px 0 0 #7a8793;
          }

          .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody tr[data-trip-row='al'] td {
            background: #d8dde4 !important;
            color: #1f2937 !important;
            box-shadow: inset 3px 0 0 #6b7280;
          }

          .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody .text-muted,
          .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody .small.text-muted {
            color: #64748b !important;
            opacity: 1 !important;
          }

          .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody tr[data-trip-row='al'] .btn-outline-secondary,
          .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody tr[data-trip-row='al'] .btn-outline-success,
          .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody tr[data-trip-row='al'] .btn-outline-primary,
          .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody tr[data-trip-row='al'] .btn-outline-info,
          .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody tr[data-trip-row='al'] .btn-outline-danger {
            ...
            --bs-btn-active-bg: rgba(148, 163, 184, 0.14);
            --bs-btn-active-border-color: rgba(148, 163, 184, 0.65);
          ...
          html[data-bs-theme='dark'] .trip-dashboard-sheet-table tbody tr[data-trip-row='al'] td {
            background: #9ca3af !important;
            color: #f8fafc !important;
          }

          html[data-bs-theme='dark'] .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody tr td {
            background: #18202c !important;
            color: #e5e7eb !important;
          }

          html[data-bs-theme='dark'] .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody tr:nth-child(even) td {
            background: #212a37 !important;
          }

          html[data-bs-theme='dark'] .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody tr.table-primary td {
            background: #2a3340 !important;
            color: #f3f4f6 !important;
            box-shadow: inset 3px 0 0 #9ca3af;
          }

          html[data-bs-theme='dark'] .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody tr.table-success td {
            background: #252e3a !important;
            color: #f3f4f6 !important;
            box-shadow: inset 3px 0 0 #9ca3af;
          }

          html[data-bs-theme='dark'] .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody tr[data-trip-row='al'] td {
            background: #4b5563 !important;
            color: #f8fafc !important;
            box-shadow: inset 3px 0 0 #d1d5db;
          }

          html[data-bs-theme='dark'] .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody .text-muted,
          html[data-bs-theme='dark'] .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody .small.text-muted {
            color: #94a3b8 !important;
          }

          html[data-bs-theme='dark'] .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody tr[data-trip-row='al'] .btn-outline-secondary,
          html[data-bs-theme='dark'] .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody tr[data-trip-row='al'] .btn-outline-success,
          html[data-bs-theme='dark'] .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody tr[data-trip-row='al'] .btn-outline-primary,
          html[data-bs-theme='dark'] .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody tr[data-trip-row='al'] .btn-outline-info,
          html[data-bs-theme='dark'] .trip-dashboard-sheet-table.trip-dashboard-sheet-table--scanner-neutral tbody tr[data-trip-row='al'] .btn-outline-danger {
            --bs-btn-color: #e5e7eb;
            ...
            --bs-btn-active-border-color: rgba(148, 163, 184, 0.6);
            background-color: transparent;
            box-shadow: none;
          }
